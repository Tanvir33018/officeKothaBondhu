...
public class ImageShaper {
    public static Bitmap getRoundedCornerImage(Bitmap bitmap, int radius) {
        bitmap.createScaledBitmap(bitmap, radius, radius, true)
                .createScaledBitmap(bitmap, radius, radius, true)
                .compress(Bitmap.CompressFormat.PNG, 50, new ByteArrayOutputStream());
